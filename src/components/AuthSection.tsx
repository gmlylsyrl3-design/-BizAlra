    ...
    <div className="max-w-md mx-auto w-full" dir={lang === "he" ? "rtl" : "ltr"}>
      ...
      <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-6 space-y-4">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 border border-input rounded-xl bg-background hover:bg-[#001830] hover:text-[#F5F5DC] transition-colors text-sm font-medium"
        >
