...
const translations: Translations = {
  ...
  "nav.dashboard": { he: "מרכז בקרה ופרופיל ניהולי", en: "Executive Control Center & Administrative Profile" },
  "nav.support": { he: "מרכז תמיכה וייעוץ טכנולוגי", en: "Technical Support & Advisory Center" },
  ...
  "tool.photos.title": { he: "סטודיו ויזואלי ומחולל מדיה", en: "Visual Studio & Media Generator" },
  "tool.photos.desc": { he: "הפקת הדמיות מוצר, לוגו מותגי, מיתוג פרופיל ונכסי סטורי", en: "Production of product visuals, brand logos, profile branding and story assets" },
  "tool.messages.title": { he: "מערך תכתובת ומסרים מבוססי AI", en: "AI-Powered Messaging & Communication Suite" },
  "tool.messages.desc": { he: "פיתוח נוסחי שיווק וקופירייטינג מתקדם", en: "Development of advanced marketing copy and copywriting" },
  "tool.analytics.title": { he: "ארכיטקטורה ואנליזה עסקית", en: "Business Architecture & Analytics" },
  "tool.analytics.desc": { he: "הפקת תובנות אסטרטגיות ומסקנות מבוססות דאטה", en: "Generation of strategic insights and data-driven conclusions" },
  ...
  "tool.time.title": { he: "אופטימיזציה ותזמון משאבים", en: "Resource Optimization & Scheduling" },
  "tool.time.desc": { he: "ייעול תהליכי עבודה וניהול לוחות זמנים", en: "Optimization of workflows and schedule governance" },
  "tool.pricing.title": { he: "מודלים ואסטרטגיות תמחור", en: "Pricing Models & Strategy" },
  "tool.pricing.desc": { he: "הנדסת מחירונים ואופטימיזציית רווחיות", en: "Pricing architecture and profitability optimization" },
  "tool.calendar.title": { he: "יומן פעילות וסנכרון תאריכים מרכזיים", en: "Activity Journal & Key Date Synchronization" },
  "tool.calendar.desc": { he: "ניטור פגישות מפתח, אבני דרך ואירועים עסקיים", en: "Monitoring of key meetings, milestones and business events" },
  ...
  // Create Page
  "create.title": { he: "מרחב הפקה ופיתוח נכסים", en: "Asset Production & Development Workspace" },
  ...
  // Support
  "support.title": { he: "מרכז תמיכה וייעוץ טכנולוגי", en: "Technical Support & Advisory Center" },
  ...
  "dash.manageSub": { he: "סטטוס מנוי ותנאי התקשרות", en: "Subscription Status & Service Terms" },
  "dash.manageSubDesc": { he: "ניטור חבילת שירות, ניצול אשראי והרחבות", en: "Monitoring service bundles, credit utilization and add-ons" },
  "dash.supportTitle": { he: "מרכז תמיכה וייעוץ טכנולוגי", en: "Technical Support & Advisory Center" },
  "dash.supportDesc": { he: "פתרון תקלות בזמן אמת ומענה מקצועי מבוסס AI", en: "Real-time issue resolution and expert AI-assisted support" },
  "dash.guest": { he: "אורח", en: "Guest" },
  "dash.personalAreaTitle": { he: "מרכז בקרה ופרופיל ניהולי", en: "Executive Control Center & Administrative Profile" },
